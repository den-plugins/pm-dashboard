...
## Resource Cost Forecast
  - view weekly/monthly view of cost per member (in Project Team) according to their rate (internal/SOW)
...
## Project Billability
  - view labour, forecast, and actual hours of all billable members of project,
    where billable_member = member with resource_allocation != 0 && resource_type = billable within project duration
  - view graph of billability history, from project start date to recent week
...
## Project Contracts
  - create, list, edit project contracts
  - attach pdf file/s to a project contract
