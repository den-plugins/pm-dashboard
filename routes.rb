...
map.with_options(:controller => "notes") do |r|
 r.custom_notes 'projects/:project_id/project_management/notes/:action'
end
...
map.connect 'projects/:project_id/project_management/efficiency/setting/:action', :controller => 'efficiency'
